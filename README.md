...
Provides a unified `ggseg_atlas` object with both 2D polygon geometry and 3D
meshes derived from the Shen whole-brain parcellation of 268 functional nodes.
...
This is the Shen 268-parcel functional parcellation derived from resting-state
fMRI data, covering the whole brain including cortical, subcortical, and
cerebellar regions.

Reference: Shen X, Tokoglu F, Papademetris X, Constable RT (2013) Groupwise
