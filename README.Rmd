...
Shen X et al. (2013). Groupwise whole-brain parcellation from resting-state
fMRI data for network node identification. *NeuroImage*, 82, 403-415.

## Code of Conduct

Please note that the ggsegShen project is released with a
